...
**Impacto:** adição de um bloco de countdown regressivo abaixo do título da faixa, visível apenas quando a faixa tem `intro_ms` definido e a posição atual ainda está antes do intro.
...
│                                                                  │
│  ┌──────────────────────────────┐                               │
│  │  INTRO  00:08                │  ← contador regressivo        │
│  └──────────────────────────────┘    amarelo → vermelho < 5s    │
│                                                                  │
│  VOL ──────────●  85%   NORM −2.1 dB                           │
└─────────────────────────────────────────────────────────────────┘
...
- Bloco visível apenas quando `intro_ms` está definido E posição < intro_ms.
- Cor amarela enquanto intro > 10 s, muda para vermelho nos últimos 5 s.
- Some automaticamente quando a posição cruza `intro_ms`.
